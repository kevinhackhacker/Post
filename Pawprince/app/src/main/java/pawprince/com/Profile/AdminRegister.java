...
public class AdminRegister extends AppCompatActivity {
    ...
    EditText mUsername, mEmail, mAddress, mPassword, mBirthdate, mAge, mGender, mCityprov, mReligion, mNationalism, mContactN, mZipCode;
    TextView mLoginBtn;
    FirebaseAuth fAuth;
    FirebaseFirestore fStore;
    StorageReference storageReference;
    ConstraintLayout first, second, third;
    ImageView imageButton;
    ImageView imageButton2;
    Button next;
    EditText mResultEt, mResultEt2;
    ImageView mPreviewIv, mPreviewIv2;
    TextView errorT;
    Uri image_uri = null;
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        mCityprov = findViewById(R.id.etCityProvince);
        mReligion = findViewById(R.id.etReligion);
        mNationalism = findViewById(R.id.etNationalism);
        mEmail = findViewById(R.id.etEmail);
        mZipCode = findViewById(R.id.etZipCode);
        mAddress = findViewById(R.id.etAddress);
        mPassword = findViewById(R.id.etPassword);
        mBirthdate = findViewById(R.id.etBirthdate);
        mContactN = findViewById(R.id.etContactNumber);
        ...
        imageButton2 = findViewById(R.id.kodak);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String nationalism = mNationalism.getText().toString().trim();
                final String contactn = mContactN.getText().toString().trim();
                final String religion = mReligion.getText().toString().trim();
                final String zipcode = mZipCode.getText().toString().trim();
                final String cityprovince = mCityprov.getText().toString().trim();
                ...
                if (next.getText().equals("Confirm")) {
                    ...
                    if (TextUtils.isEmpty(contactn)) {
                        mContactN.setError(("Contact Number is required."));
                        return;
                    }
                    ...
                    if (TextUtils.isEmpty(zipcode)) {
                        mZipCode.setError("Zipcode is required.");
                        return;
                    }
                    if (TextUtils.isEmpty(cityprovince)) {
                        mCityprov.setError("City/Province is required.");
                        return;
                    }
                    if (TextUtils.isEmpty(religion)) {
                        mReligion.setError(("Religion is required."));
                        return;
                    }
                    if (TextUtils.isEmpty(nationalism)) {
                        mNationalism.setError(("Nationalism is required."));
                        return;
                    }
                                        ...
                                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                            Imagename.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                ...
                                                public void onSuccess(Uri uri) {
                                                    Toast.makeText(AdminRegister.this, "User Created Enjoy Pawprince application", Toast.LENGTH_SHORT).show();
                                                    userID = fAuth.getCurrentUser().getUid();
                                                    DocumentReference documentReference = fStore.collection("users").document(userID);
                                                    Map<String, Object> admin = new HashMap<>();
                                                    admin.put("fName", username);
                                                    admin.put("email", email);
                                                    admin.put("address", address);
                                                    admin.put("birthdate", birthdate);
                                                    admin.put("age", age);
                                                    admin.put("gender", gender);
                                                    admin.put("contact number", contactn);
                                                    admin.put("zip code", zipcode);
                                                    admin.put("nationalism", nationalism);
                                                    admin.put("religion", religion);
                                                    admin.put("city/province", cityprovince);
                                                    admin.put("Result Valid Id", resultT);
                                                    admin.put("Image Valid Id", String.valueOf(uri));
                ...
                if (resultCode == RESULT_OK) {
                    ...
                    if (!recognizer.isOperational()) {
                        ...
                        for (int it = 0; it < items.size(); it++) {
                            ...
                            sb.append(myItem.getValue());
                            sb.append("\n\n");
                            if (sb.toString().contains("NATIONAL BUREAU OF INVESTIGATION")) {
                                Toast.makeText(this, "VERIFIED ID", Toast.LENGTH_LONG).show();
                            } else if (sb.toString().contains("POSTAL IDENTITY CARD")) {
                                Toast.makeText(this, "VERIFIED ID", Toast.LENGTH_LONG).show();
                            }else if(sb.toString().contains("Social Security System")){
                                Toast.makeText(this, "VERIFIED ID", Toast.LENGTH_LONG).show();
                            }else if(sb.toString().contains("REPUBLIKA NG PILIPINAS")){
                        ...
                        //set text to edit text
                        mResultEt2.setText(sb.toString());
